...
export const AUTO_COUNTDOWN_STARTED = "auto_countdown_started";
export const AUTO_COUNTDOWN_CANCELLED = "auto_countdown_cancelled";
export const NFT_AWARDED = "nft_awarded";
